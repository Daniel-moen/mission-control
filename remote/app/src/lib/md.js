// Markdown → sanitized HTML for the document viewer. Docs come from our own
...
// Short alias — `render(md)` reads better at the call site.
export const render = renderMarkdown;
